...
RUN echo "deb http://ppa.launchpad.net/ondrej/php/ubuntu xenial main" > /etc/apt/sources.list.d/ondrej-php-xenial.list && \
    ...
    echo "deb http://ppa.launchpad.net/pinepain/libv8/ubuntu xenial main" > /etc/apt/sources.list.d/pinepain-libv8-xenial.list && \
    echo "deb http://ppa.launchpad.net/pinepain/libv8-archived/ubuntu xenial main" > /etc/apt/sources.list.d/pinepain-libv8-archived-xenial.list && \
